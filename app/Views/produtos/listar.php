...
<head>
    ...
    <style>
        ...
        .alerta-estoque-maximo {
            background-color: #fff3cd;
            color: #856404;
            font-weight: bold;
        }

        .alerta-estoque-excedido {
            ...
            <tbody>
                <?php foreach ($produtos as $produto): ?>
                    <?php
                        ...
                        $estoqueMax = isset($produto['estoque_maximo']) && $produto['estoque_maximo'] !== null
                            ? (int) $produto['estoque_maximo']
                            : null;
                        $classeCelula = '';
                        if ($estoqueMax !== null) {
                            if ($qtd >= $estoqueMax) {
                                $classeCelula = 'alerta-estoque-excedido';
                            } elseif ($estoqueMax > 0 && $qtd >= $estoqueMax * 0.9) {
                                $classeCelula = 'alerta-estoque-maximo';
                            }
                        }
                    ?>
                    <tr>
                        ...
                        <td class="<?= $classeCelula ?>"><?= $qtd ?></td>
                        <td><?= $estoqueMax !== null ? $estoqueMax : '—' ?></td>
