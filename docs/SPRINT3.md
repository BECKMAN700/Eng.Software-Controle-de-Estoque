...
- `PUT` e `PATCH` em `api_produtos` para atualizar produtos.
...
2. Acessar `index.php?acao=api_produtos` e confirmar a lista em JSON.
3. Acessar `index.php?acao=api_produtos&id=1` e confirmar o produto com historico.
